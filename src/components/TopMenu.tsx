            ...
            <div className='flex flex-row absolute items-center right-5 h-full'>
                {
                    session ? (
                        ...
                        <Link href="/api/auth/signin" className='flex items-center'>
                            <div className='flex items-center h-[70%] px-4 py-2 bg-[#0218A0] text-white rounded-lg hover:bg-[#021382] transition duration-200 ease-in-out cursor-pointer ml-5'>
