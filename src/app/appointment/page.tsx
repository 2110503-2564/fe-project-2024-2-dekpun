...
export default function Appointment() {
    ...
    const makeAppointment = async () => {
        ...
        if (!formData.nameLastname || !formData.tel || !formData.gender || !formData.purpose || !formData.dentist || !formData.appointmentDate) {
        ...
        try {
            ...
            await addAppointment(token, formData.dentist, appointmentData);
